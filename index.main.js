...
(() => {
  ...
  cellDivs.forEach((cell) => {
    cell.addEventListener("click", () => {
      ...
      _factories__WEBPACK_IMPORTED_MODULE_2__.player1.playerBoard.changeOrientation(xCoord, yCoord);
    });
  });
